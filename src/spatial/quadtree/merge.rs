...
use super::serialization::{CellReader, CollapseDetector};
use crate::spatial::quadtree::{Bounds, ClippedShape, Point2D, QuadtreeCell, QuadtreeCellId, Rect};
...
mod merge_tests {
    ...
    use super::*;
    use crate::spatial::quadtree::serialization::{write_cells, CellWriter, CellWriterOptions};
