...
fn get_level_for_max_value(value: f64) -> u8 {
    ...
    (-level).clamp(0, S2CellId::MAX_LEVEL as i32) as u8
}
...
impl IndexBuilder {
    ...
    fn get_edge_max_level(&self, v0: &[f64; 3], v1: &[f64; 3]) -> u8 {
    ...
    fn update_face_edges(&mut self, face: u8, face_edges: &[FaceEdge]) {
