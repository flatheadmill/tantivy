...
fn middle(ij_lo: [i32; 2], level: u8, padding: f64) -> R2Rect {
...
impl S2PaddedCell {
    ...
    pub fn from_parent(parent: &S2PaddedCell, i: usize, j: usize) -> Self {
        let pos = s2coords::ij_to_pos(parent.orientation, i as u8, j as u8);
    ...
    #[inline]
    pub fn get_child_ij(&self, pos: u8) -> (usize, usize) {
    ...
    pub fn shrink_to_fit(&self, rect: &R2Rect) -> S2CellId {
        ...
        let level = MAX_CELL_LEVEL - (31 - level_msb.leading_zeros() as u8);
