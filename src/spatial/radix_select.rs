//! Radix selection for BKD tree partitioning.
//!
//! Implements byte-wise histogram selection to find median values without comparisons, enabling
//! efficient partitioning of spatial data during BKD tree construction. Processes values through
//! multiple passes, building histograms for each byte position after a common prefix, avoiding the
//! need to sort or compare elements directly.
